...
export default {
    mongodb: {
        ...
        allowDiskUse: getBoolean(
            process.env.ME_CONFIG_MONGODB_ALLOW_DISK_USE,
            false,
        ),
        ...
        connectionOptions: {
            ...
            tlsAllowInvalidCertificates: getBoolean(
                process.env.ME_CONFIG_MONGODB_TLS_ALLOW_CERTS,
                true,
            ),
            ...
            tlsCertificateKeyFile:
                process.env.ME_CONFIG_MONGODB_TLS_CERT_KEY_FILE,

            // tlsCertificateKeyFilePassword: password for the client key PEM
            tlsCertificateKeyFilePassword:
                process.env.ME_CONFIG_MONGODB_TLS_CERT_KEY_FILE_PASSWORD,
        ...
        awsDocumentDb: getBoolean(
            process.env.ME_CONFIG_MONGODB_AWS_DOCUMENTDB,
            false,
        ),
    ...
    useBasicAuth: getBoolean(
        getFileEnv(basicAuthEnabled) || getFileEnv(basicAuth),
    ),
    ...
    options: {
        ...
        collapsibleJSON: getBoolean(
            process.env.ME_CONFIG_OPTIONS_COLLAPSIBLE_JSON,
            true,
        ),
        ...
        confirmDelete: getBoolean(
            process.env.ME_CONFIG_OPTIONS_CONFIRM_DELETE,
            false,
        ),
